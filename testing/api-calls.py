...
inputs = {"messages": [("system", "You are helpful assistant that helps users find weather data. End every response with a Thank you. ")]}

for state in graph.stream(inputs, stream_mode="values"):
    last_message = state["messages"][-1]
    last_message.pretty_print()

state["messages"].append(("human", "What's the weather in New York on 2025-09-19 at 16:00?"))
